...
const uint32_t KEYMAP[][MATRIX_COL_NUM * MATRIX_ROW_NUM * 2] = {
    [_BS] = {
        ...
        XXXXXXX, XXXXXXX, KC_LGUI, KC_LALT, KC_L1,   KC_SPC,  XXXXXXX, XXXXXXX, KC_RSFT, KC_L2,   KC_RALT, KC_RGUI, XXXXXXX, XXXXXXX
    },
    [_L1] = {
    ...
    [_L2] = {
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   _______, KC_PGUP, KC_HOME, KC_UP,   KC_END,  _______, _______,
        _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_PRWD, _______, KC_NXWD, _______, _______,
        _______, _______, _______, _______, KC_L3,   _______, _______, _______, _______, _______, _______, _______, _______, _______
    },
    [_L3] = {
        _______, KC_DVC1, KC_DVC2, KC_DVC3, KC_DVCN, _______, _______, _______, KC_PAST, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, KC_NLCK,
